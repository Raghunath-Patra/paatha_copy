...
const HeroSection = ({ onCreateNew, hasProjects }: { onCreateNew: () => void, hasProjects: boolean }) => {
  ...
  if (// File: frontend/app/video-generator/page.tsx (Enhanced Landing Page)
'use client';
...
const HeroSection = ({ onCreateNew }: { onCreateNew: () => void }) => {
  const encouragingTexts = [
    ...
    "AI-powered video generation at your fingertips",
    "Bring your stories to life with AI",
    "Generate engaging videos effortlessly"
  ];
